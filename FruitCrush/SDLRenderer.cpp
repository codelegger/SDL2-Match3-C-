...
static const char *textureNames[] = {
	"images/bg.jpg",
	"images/piece_blue.png",
	"images/piece_green.png",
	"images/piece_purple.png",
	"images/piece_red.png",
	"images/piece_yellow.png",
};
...
struct SDLRenderer::impl
{
    ...
    void drawTextWithColor(const char *text, int x, int y,int r,int g, int b);
...
defaultFont(nullptr)
{
	...
	defaultFont = TTF_OpenFont("/images/OldProvidence.ttf", 48);
...
void SDLRenderer::impl::drawTextWithColor(const char *text, int x, int y,int r,int g,int b)
{
    SDL_Color col;
...
void SDLRenderer::drawTextWithColor(const char *text, int x, int y,int r , int g , int b)
{
    pimpl->drawTextWithColor(text, x, y,r,g,b);
}
